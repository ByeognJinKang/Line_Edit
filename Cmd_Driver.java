...
****************************************************************************/
{
   ...
   public void Cmd_F(File_Buffer FILE, int nLines, String findstr)
   {
       ...
       CLN=Math.max(FILE.GetCLN(), Margin_Left);
       end=Math.min(Math.min(CLN+nLines,FILE.NumLins()), Margin_Right);
   ...
   public void Cmd_R(File_Buffer FILE, int nLines, String strF, String strT)
   {
       ...
       CLN=Math.max(FILE.GetCLN(), Margin_Left);
       endCLN=Math.min(Math.min(CLN+nLines-1,FILE.NumLins()), Margin_Right);
   ...
   public void Cmd_O(File_Buffer FILE, int nLines)
   {
       ...
       CLN=Math.max(FILE.GetCLN(), Margin_Left);
       end=Math.min(Math.min(CLN+nLines-1,FILE.NumLins()), Margin_Right);
